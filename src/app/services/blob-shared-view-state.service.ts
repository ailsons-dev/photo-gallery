...
export class BlobSharedViewStateService {
  private selectedContainerInner$ = new BehaviorSubject<string>("mybucket-teste");
  ...
  get selectedContainer$() {
     this.selectedContainerInner$.next("mybucket-teste");
     this.selectedContainerInner$.complete();
